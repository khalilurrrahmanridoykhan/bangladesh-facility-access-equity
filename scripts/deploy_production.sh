...
install -m 0644 android/app/build/outputs/apk/release/app-release.apk web/downloads/shasthopath-1.2.1.apk
(cd web/downloads && sha256sum shasthopath-1.2.1.apk > shasthopath-1.2.1.apk.sha256)
APK_SHA256="$(sha256sum web/downloads/shasthopath-1.2.1.apk | awk '{print $1}')"
printf '{\n  "version": "1.2.1",\n  "version_code": 6,\n  "apk_url": "https://shasthopath.krrkhan.com/downloads/shasthopath-1.2.1.apk",\n  "sha256": "%s"\n}\n' "$APK_SHA256" > web/app-version.json
